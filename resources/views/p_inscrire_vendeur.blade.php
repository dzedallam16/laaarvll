...
<div class="col-md-6">
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      <input type="text" name="num_vendeur" class="form-control"> </div>

     

    <label class="label col-md-3 control-label">Email :</label>
    <div class="col-md-8">
      <input type="text" name="email_vendeur" class="form-control" > </div> 

    <label  class="label col-md-3 control-label">Pass word :</label>
    <div class="col-md-8">
      <input type="password" name="mdps_vendeur" class="form-control" > </div> 
