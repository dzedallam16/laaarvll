...
<body>
     ...
     <div class="container">
        ...
        <a href="#" class="navbar-brand">Vendor Profile</a>   
            <button
  ...
  <div class="btn-group" role="group">
    ...
    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
      <li><a class="dropdown-item" href="/addvendeur">Add Matreil</a></li>
            <li><a class="dropdown-item" href="test">gestion vendeurs</a></li>
                  <li><a class="dropdown-item" href="/consult">Consult list Matreil</a></li>
